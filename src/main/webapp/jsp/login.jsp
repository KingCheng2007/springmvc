			...
			<div class="form-group"
				...
				<div class="input-group">
					...
					<span class="input-group-addon"><img
						src="image/icon_user.png" style="height: 20px; width: 20px"
						alt="..."> </span> <input type="text" name="userName"
						class="form-control" placeholder="用户名" required autofocus>
				</div>
				<br>
				<div class="input-group">
					<span class="input-group-addon"><img
						src="image/icon_psw.png" style="height: 20px; width: 20px"
						alt="..."> </span> <input type="password" name="password"
